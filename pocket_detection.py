...
# Configuration
INPUT_VIDEO = os.path.join("shoplifting", "shoplifting-5.mp4")
OUTPUT_VIDEO = os.path.join("output_botsort", "phone_pocket_detection.mp4")
...
def main():
    ...
    os.makedirs("output_botsort", exist_ok=True)
    ...
    cap.release()
    out.release()
    print(f"✅ Saved advanced processed video to: {OUTPUT_VIDEO}")
